...
# print(alor.set_limit_order(ticker='GAZP', quantity=5, price=290, side='buy'))

# print('\n Установить рыночную заявку: купить 10 лотов GAZP по рынку')
# print(alor.set_market_order(ticker='GAZP', quantity=10, side='buy'))

# print('\n Изменяю лимитную заявку №24640949466')
print(alor.change_limit_order(ticker='GAZP', side='buy',
                              quantity=10, price=295, order_id='24640949466'))

print('\n Отменяю лимитню заявку №24643050518')
print(alor.cancel_order(order_id='24643050518', stop=False))

# print('\n Создаем стоп-лосс заявку ')
print(alor.set_stoploss(ticker='GAZP', side='sell', quantity=5, price=201,
                        trade_server_code='TRADE', account='L01-00000F00'))
print(alor.jwt_token)

print('\n Отменяю стоп-заявку №347680')
print(alor.cancel_order(order_id='347680', stop=True))
...
# print('\n Запрос информации об имеющихся ценных бумагах GAZP')
